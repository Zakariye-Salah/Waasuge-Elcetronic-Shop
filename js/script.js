...
const SHOP_NAME = "Waasuge Electronics & Mobile Repairing";
const SHOP_PHONE = "0617125558";
const SHOP_WHATSAPP = "252617125558";
const SHOP_EMAIL = "waasugeelectronics@gmail.com";
...
function renderRepair(repair, repairs = lastRepairCollection, options = {}) {
  ...
  const shopName = repair?.shopName || SHOP_NAME;
  const shopPhone = repair?.shopPhone || SHOP_PHONE;
  ...
  const email = repair?.email || repair?.shopEmail || SHOP_EMAIL;
    ...
    <div class="tracking-premium-shell fade-in-up">
      <div class="tracking-header-card mb-4">
        <div class="d-flex flex-column gap-3 text-start">
          <div>
            <div class="small text-uppercase fw-bold text-primary">${escapeHtml(SHOP_NAME)}</div>
